...
export default function AddFoodModal({ food, foods, onClose, onSave }) {
  ...
  async function handleSubmit(event) {
    ...
    setSaving(true)
    try { await onSave({ ...food, name: cleanName, description: description.trim(), active }); onClose() }
    catch { setError('Não foi possível salvar o alimento. Tente novamente.') }
